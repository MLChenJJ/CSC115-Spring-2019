...
public class CarbonCalculator {
    ...
    public static int calcAutoUsage ( double fuelEfficiency, int kmPerDay ) {
        ...
        double liters_per_year = DAYS_PER_YR * (kmPerDay * (fuelEfficiency/100));
    ...
    {
    	double manufacturing = GJ_MANUF_COST*1.0 / age;
    ...
    public static int calcCarbonFootprint ( double[] data)
    {
    	...
    	double tons = (auto_usage + auto_ownership + transit)/KGS_PER_METRIC_TON;
    	return (int)tons;
